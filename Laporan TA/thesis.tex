...
% 	\rfoot{Halaman \thepage}%
    ...
    \titleEN{Environmental Sound Classification Using Piczak CNN Based on Spectrogram Representation}
    % JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    
    % Informasi Mahasiswa
    \author{IGNATIUS JULIO BINTANG REGEN}		% Nama Mahasiswa
	\nim{121140192}				% NIM Mahasiswa
